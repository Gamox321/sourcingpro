...
rrhh_urlpatterns = ([
    ...
    path('trabajadores/', views_rrhh.RRHHTrabajadoresView.as_view(), name='trabajadores'),
    path('procesos/', views_rrhh.RRHHProcesosView.as_view(), name='procesos'),
    path('procesos/<int:pk>/', views_rrhh.RRHHProcesoDetailView.as_view(), name='proceso_detalle'),
    path('cecos/', views_rrhh.RRHHCecosView.as_view(), name='cecos'),
    path('reportes/', views_rrhh.RRHHReportesView.as_view(), name='reportes'),
    path('configuracion/plazos/', views_rrhh.RRHHConfigPlazosView.as_view(), name='config_plazos'),
    path('alertas/contratos/', views_rrhh.RRHHAlertasContratosView.as_view(), name='alertas_contratos'),
    path('procesos/<int:pk>/confirmar-cierre/', views_rrhh.RRHHConfirmarCierreTerminoView.as_view(), name='confirmar_cierre_termino'),
], 'rrhh')

ti_urlpatterns = ([
    path('', views_ti.TIDashboardView.as_view(), name='dashboard'),
    path('inventario/', views_ti.TIInventarioView.as_view(), name='inventario'),
    path('inventario/nuevo/', views_ti.TIAssetCreateView.as_view(), name='asset_create'),
    path('tablero/', views_ti.TITableroGeneralView.as_view(), name='tablero'),
    path('bloqueo-urgente/', views_ti.TIBloqueoUrgenteView.as_view(), name='bloqueo_urgente'),
    path('bloqueo-urgente/<int:pk>/confirmar/', views_ti.TIConfirmarBloqueoView.as_view(), name='confirmar_bloqueo'),
], 'ti')

jefatura_urlpatterns = ([
    path('', views_jefatura.JefaturaNominaView.as_view(), name='nomina'),
    path('trabajador/<int:pk>/', views_jefatura.JefaturaTrabajadorDetailView.as_view(), name='trabajador_detail'),
...
logistica_urlpatterns = ([
    ...
    path('devoluciones/', views_logistica.LogisticaDevolucionesView.as_view(), name='devoluciones'),
    path('devoluciones/<int:pk>/registrar/', views_logistica.LogisticaRegistrarDevolucionView.as_view(), name='registrar_devolucion'),
    path('recuperaciones/', views_logistica.LogisticaRecuperacionesView.as_view(), name='recuperaciones'),
    path('recuperaciones/<int:pk>/registrar/', views_logistica.LogisticaRegistrarRecuperacionView.as_view(), name='registrar_recuperacion'),
    path('inventario/', views_logistica.LogisticaInventarioView.as_view(), name='inventario'),
    path('tablero/', views_logistica.LogisticaTableroView.as_view(), name='tablero'),
], 'logistica')
