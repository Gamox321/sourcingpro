...
class KanbanColumnPartialView(RoleRequiredMixin, TemplateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        estados_map = {
            ...
            'completadas': [Task.EstadoChoices.COMPLETADA, Task.EstadoChoices.GESTIONADO_EXTERNO],
        }
    ...
    def get_context_data(self, **kwargs):
        ...
        task = get_object_or_404(
            Task.objects.select_related(
                'proceso__trabajador', 'proceso__usuario_inicio',
                'proceso__ceco_origen', 'proceso__ceco_destino',
                'usuario_responsable',
            ),
            pk=self.kwargs['pk'],
        )
