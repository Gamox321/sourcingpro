...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        clientes_data = [
            {'nombre': 'Codelco', 'descripcion': 'Corporación Nacional del Cobre de Chile'},
            {'nombre': 'BHP', 'descripcion': 'BHP Group — Minera Escondida'},
            {'nombre': 'Minera Los Pelambres', 'descripcion': 'Antofagasta Minerals — Minera Los Pelambres'},
            {'nombre': 'Anglo American', 'descripcion': 'Anglo American plc — División Chilena'},
        ]
        created_clients = []
        ...
        cecos_data = [
            ...
            {'nombre': 'Planta Concentradora', 'codigo': 'PLANTA-001', 'cliente_idx': 0},
            {'nombre': 'Fundición', 'codigo': 'FUND-001', 'cliente_idx': 0},
            {'nombre': 'Escondida Norte', 'codigo': 'ESCN-001', 'cliente_idx': 1},
            {'nombre': 'Operaciones Los Pelambres', 'codigo': 'LPEL-001', 'cliente_idx': 2},
