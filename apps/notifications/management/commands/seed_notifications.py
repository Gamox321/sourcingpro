...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        if not admin:
            self.stdout.write(self.style.ERROR('No hay administrador. Ejecuta bootstrap_admin primero.'))
            return
        ...
        self.stdout.write(self.style.SUCCESS(f'{creadas} configuraciones de notificación creadas.'))
