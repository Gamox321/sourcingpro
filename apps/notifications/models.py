...
class Notification(models.Model):
    ...
    tipo_evento = models.CharField(
        max_length=100, verbose_name="Tipo de evento", db_index=True
    )
    contenido = models.TextField(verbose_name="Contenido")
    canal = models.CharField(
        max_length=10, choices=CanalChoices.choices, verbose_name="Canal"
    )
...
class NotificationConfig(models.Model):
    ...
    usuario_modifico = models.ForeignKey(
        "accounts.User", on_delete=models.CASCADE, verbose_name="Modificado por"
    )
