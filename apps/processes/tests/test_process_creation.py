...
class TestCrearProcesoContratacion:
    ...
    def test_tasks_are_created_for_contratacion(
        self, rrhh_user, cost_center, epp_asset
    ):
        from apps.processes.services import crear_proceso_contratacion
...
class TestCrearProcesoCierreTypes:
    ...
    def test_despido_creates_tasks_and_alerts(
        self, rrhh_user, worker_fixture, logistica_user
    ):
    ...
    def test_despido_alerts_logistica_users(
        self, rrhh_user, worker_fixture, logistica_user
    ):
        from apps.processes.services import crear_proceso_despido
