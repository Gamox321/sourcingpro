...
urlpatterns = [
    ...
    path('procesos/nuevo/asignacion-activos/', views.ProcessCreateAsignacionActivosView.as_view(), name='process_create_asignacion_activos'),
    ...
    path('procesos/<int:pk>/tareas/<int:task_pk>/registrar-cuenta/', views.TaskAccountCreateView.as_view(), name='task_account_create'),
]
