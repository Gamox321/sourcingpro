...
urlpatterns = [
    ...
    path('inventario/<int:pk>/editar/', views.AssetUpdateView.as_view(), name='asset_edit'),
    path('inventario/<int:pk>/asignar/', views.AssetAssignView.as_view(), name='asset_assign'),
    path('inventario/<int:pk>/devolver/', views.AssetReturnView.as_view(), name='asset_return'),
