...
class AssetAssignmentInline(admin.TabularInline):
    ...
    extra = 0
    readonly_fields = ('fecha_asignacion', 'fecha_devolucion', 'estado_devolucion', 'trabajador')
    can_delete = False
...
class AssetAssignmentAdmin(admin.ModelAdmin):
    list_display = ('activo', 'trabajador', 'fecha_asignacion', 'fecha_devolucion', 'estado_devolucion')
