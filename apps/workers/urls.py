...
urlpatterns = [
    ...
    path(
        "trabajadores/<int:pk>/", views.WorkerDetailView.as_view(), name="worker_detail"
    ),
    path(
    ...
    path(
        "trabajadores/<int:pk>/eliminar/",
        views.WorkerDeleteView.as_view(),
        name="worker_delete",
    ),
    path(
        "trabajadores/<int:pk>/cambiar-estado/",
        views.WorkerStateChangeView.as_view(),
        name="worker_state_change",
    ),
]
